...
public class ChooseProActivity extends BaseActivity {
	...
	protected void saveMajor() {
		
		Intent intent=getIntent();
		String oldMajor=intent.getStringExtra("major");
		Major=edit_pro.getText().toString().trim();
		Message msg = handler.obtainMessage();
		if(Major.equals(oldMajor))
		{
			msg.what=5;
